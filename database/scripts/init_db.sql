...
insert into roles(rol_name) values("client"),("seller"),("admin");
...
insert into documents(document_type) values("national id"),("identity card"),("foreign id"),("passport");
...
CREATE TABLE users (
    ...
    FOREIGN KEY (id_document_type) REFERENCES documents(id_document_type) ON DELETE SET NULL
);
